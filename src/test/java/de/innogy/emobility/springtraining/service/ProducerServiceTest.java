...
import de.innogy.emobility.springtraining.config.RabbitTestConfig;
...
import static de.innogy.emobility.springtraining.config.RabbitTestConfig.directQueue;
import static de.innogy.emobility.springtraining.config.RabbitTestConfig.fanoutQueue;
import static de.innogy.emobility.springtraining.config.RabbitTestConfig.sayHelloTestQueue;
...
public class ProducerServiceTest {
    ...
    public void sendUserToFanout(){
        producerServiceTestSubject.sendBeerItemToFanout();
        assertThat(rabbitTestConfig.getFanoutBeerItems()).isNotEmpty();
        log.info(rabbitTestConfig.getFanoutBeerItems().get(0).toString());
    }
